        ...
        <h1></h1>
            ...
            foreach ($listeetudiants as $etudiant) {
                $table->addRow([
                    $etudiant['nom'],
                    $etudiant['prenom'],
                    '<a href="'.url_to('modif_user', $etudiant['id']).'" class=\'bouton\'>modifier</a>',
                    '<a href=" '.url_to('delete', $etudiant['id']).'"class=\'bouton\'>supprimer</a>'
                ]);
            }
            echo $table->generate();
            //$template=[
            //'row_start'  => '<tr>',
            //'row_end'    => ' <td> <a href="'.url_to('Update','1').'">modifier</a> </td> <td> <a href="http://gestionetudiants.local/supprimer-etudiant-4">supprimer</a>  </td></tr>',
            //'row_alt_start'  => '<tr>',
            //'row_alt_end'    => ' <td> <a href="http://gestionetudiants.local/modifier-etudiant-4">modifier</a> </td> <td> <a href="http://gestionetudiants.local/supprimer-etudiant-4">supprimer</a>  </td></tr>',];
